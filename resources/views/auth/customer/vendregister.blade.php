            ...
            <section class="px-4 md:px-12 py-4 md:py-16 h-full flex items-center justify-center flex-col break-words bg-white mx-auto">
                <div class="w-full scrolling-auto" style="overflow:auto">
                    ...
                    <div class="form1 w-full h-1/2" style="overflow:auto;height:70%">
                        ...
                        <form id="vendor1" action="{{ route('vendregister') }}" method="post" class="form my-4 form-active wow animate__animated animate__fadeInUp">
                            @csrf
                        ...
                        <form id="vendor2" action="{{ route('vendregister') }}" method="post" class="form my-4 wow animate__animated animate__fadeInUp">
                            @csrf
                            ...
                            <div class="mb-2 w-full ">
                              ...
                              <small id="msg5" class="text-xs text-red-500 text-left"></small>
                            </div>
                            <div class="mb-2 w-full ">
                              ...
                              <small id="msg6" class="text-xs text-red-500 text-left"></small>
                            </div>
                            <div class="mb-2 w-full ">
                              ...
                              <small id="msg7" class="text-xs text-red-500 text-left"></small>
                            </div>
                            <div class="mb-2 w-full flex flex-col">
                                ...
                                <small id="msg8" class="text-xs text-red-500 text-left"></small>
                              </div>
                            <div class="my-4 w-full md:flex items-center justify-between">
                                <div class="w-full flex justify-center items-start flex-1 gap-3 text-left">
                                    <div class="w-auto">
                                        <input id="check" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 " type="checkbox" name="aggree" id="">
                                    </div>
                                    <label for="check" class="text-xs font-normal text-eko-blue">Creating an account means your’re okay with our 
                                        ...
                                        <small id="msg9" class="text-xs text-red-500 text-left"></small>
                                    </label>
