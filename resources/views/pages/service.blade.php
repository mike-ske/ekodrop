...
@section('contents')
        ...
        <div class="w-full sm:flex gap-4 items-start">
            ...
            <div class="w-auto mt-20">
                <div class="w-full mt-4 sm:flex gap-10">
                    <div class="flex-1 p-10 mb-10 bg-white text-left hover:shadow-2xl rounded-lg wow animate__animated animate__fadeInUp">
                    ...
                    <div class="flex-1 p-10 bg-white text-left  hover:shadow-2xl rounded-lg wow animate__animated animate__fadeInRight">
                        <div class="w-auto flex">
    ...
    <main class="w-full px-8 sm:px-20 bg-dispatch-image">
        <div class=" sm:flex w-full h-auto mx-auto mt-28">
            ...
            <div class="w-full flex-1 p-8 wow animate__animated animate__fadeInRight">
                <div class="w-full py-10">
                    <h1 class="text-blue-900 text-2xl md:text-4xl font-bold wow animate__animated animate__fadeInUp">
                        Own your own dispatch <br> bike with
                        <span class="bg-yellow-300 px-1">
                            CADNA 
                        </span>
                    </h1>
                    <p class="text-sm md:text-lg text-gray-600 text-left mt-3 wow animate__animated animate__fadeInUp" data-wow-delay="1.5s">
    ...
    <main class="w-full px-8 sm:px-20 ">
        <div class="  w-full h-auto mx-auto mt-20">
            <div class="flex items-center w-full flex-1 p-8 text-center">
                <h1 class="mx-auto text-gray-900 text-2xl md:text-4xl font-bold wow animate__animated animate__fadeInUp">
