...
@section('contents')
    ...
    <main class="w-full px-8 sm:px-20 ">
        <div style="margin-top: 45px;margin-bottom: 100px" class="mt-28  sm:flex items-center justify-between gap-8 w-full h-auto mx-auto">
            <div class="w-full flex-1 mt-20 py-4 text-center wow animate__animated animate__fadeInUp">
                ...
                <h3 class="w-full text-gray-600 font-normal text-sm wow animate__animated animate__fadeInUp">Meeting all your logistics needs in no time!</h3>
            </div>
        </div>

        <div class="w-full mt-4 sm:flex gap-10 ">
            <div  style="filter: drop-shadow(0px 4px 28px rgba(0, 0, 0, 0.04));" data-wow-delay="1s" class="wow animate__animated animate__fadeInUp flex-1 p-10 bg-white text-left hover:shadow-2xl rounded-lg">
            ...
            <div style="filter: drop-shadow(0px 4px 28px rgba(0, 0, 0, 0.04));" data-wow-delay="1.5s" class="wow animate__animated animate__fadeInUp flex-1 p-10 bg-white text-left  hover:shadow-2xl rounded-lg">
                <div class="w-auto flex">
            ...
            <div style="filter: drop-shadow(0px 4px 28px rgba(0, 0, 0, 0.04));" data-wow-delay="2s" class="wow animate__animated animate__fadeInUp flex-1 p-10 bg-white text-left  hover:shadow-2xl rounded-lg">
                <div class="w-auto flex">
        ...
        <div class="w-full sm:flex gap-10 mt-20">
            <div style="filter: drop-shadow(0px 4px 28px rgba(0, 0, 0, 0.04));" data-wow-delay="2.5s" class="wow animate__animated animate__fadeInUp  flex-1 p-10 bg-white text-left  hover:shadow-2xl rounded-lg">
                <div class="w-auto flex">
               ...
               <div class="sm:flex gap-24">
                    <div class="flex gap-6 items-start">
                        ...
                        <div class="flex-1 w-full">
                            <div class="text-gray-800 text-lg wow animate__animated animate__fadeInUp">
                            ...
                            <div style="margin-top: 3rem" class="wow animate__animated animate__fadeInUptext-gray-800 text-lg mt-8 sm:mt-16">
                                <h1>Get a dispatch bike</h1>
                                <p class="text-sm text-gray-600 text-left mt-2">
                                    Start up your own logistics service with us. Buy and pay later
                                </p>
                            </div>
                            <div class="text-gray-800 text-lg mt-8 sm:mt-16 wow animate__animated animate__fadeInUp">
        ...
        <div class=" sm:flex w-full h-auto mx-auto mt-28">
            ...
            <div class="w-full flex-1 p-8">
                <div class="w-full py-10 ">
                    <h1 class="text-blue-900 text-2xl sm:text-4xl font-bold wow animate__animated animate__fadeInUp">
                        Own your own dispatch <br> bike with
                        <span class="bg-yellow-300 px-1">
                            CADNA 
                        </span>
                    </h1>
                    <p class="text-lg text-gray-600 text-left mt-3 wow animate__animated animate__fadeInUp">
    ...
    <main class="w-full px-8 sm:px-20 ">
        <div class="  w-full h-auto mx-auto mt-20">
            <div class="flex items-center w-full flex-1 p-8 text-center wow animate__animated animate__fadeInUp">
    ...
    <main class="w-full px-8 sm:px-20 ">
        <div class="  w-full h-auto mx-auto mt-20">
            ...
            <div class="w-full sm:w-2/3 flex-col gap-8 mx-auto">
                <div class="p-3 sm:p-6 flex-1 bg-gray-100 ">
                ...
                <div class="p-3 sm:p-6 flex-1 mt-3 bg-gray-100 wow animate__animated animate__fadeInUp">
                    <div class="w-full flex items-center justify-between cursor-pointer">
    ...
    <main class="w-full px-8 sm:px-20 wow animate__animated animate__fadeInUp">
        <div style="background-position: top;background-size: cover;" class="sm:rounded-none rounded-md w-full h-auto mx-auto mt-20 mb-24 bg-phone-image bg-no-repeat">
            <div class="flex w-full  p-8 text-center">
                <div class="w-full flex-1 text-left sm:pl-8">
                    <h3 class="mx-auto text-gray-900 text-2xl sm:text-3xl wow animate__animated animate__fadeInUp">
                        Our Mobile App
                    </h3>
                    <h1 class="mx-auto mt-2 text-gray-900 text-3xl sm:text-6xl font-black wow animate__animated animate__fadeInLeft">
                        Coming Soon
                    </h1>
